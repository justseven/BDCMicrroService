...
namespace DotnetEureka.HttpSupport
{
    ...
    public abstract class DiscoveryAwareBase
    {
        ...
        protected DiscoveryAwareBase(string serviceName, string baseRoute)
        {
            ...
            //var SrvUrl = GetServiceIp(serviceName);

            var uriString = $"http://{serviceName}/{baseRoute}/";
            //var uriString = $"{SrvUrl}{baseRoute}/";
        ...
        /// <summary>
        /// seven 2018.9.12 增加获取eureka服务IP
        /// </summary>
        /// <param name="serviceName"></param>
        /// <returns></returns>
        private object GetServiceIp(string serviceName)
        {
            //Steeltoe.Discovery.Eureka.DiscoveryClient
            //var item = DiscoverySupport.discoveryClient.Applications.GetRegisteredApplication(serviceName);
            //return item.Instances.FirstOrDefault().HomePageUrl;
            return null;
        }
